...
RcppExport SEXP _mmClust_rowSumsC(SEXP xSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _mmClust_MarginalLL_v_func(SEXP NSEXP, SEXP NGSEXP, SEXP K_vSEXP, SEXP std_dataSEXP, SEXP mu_GKSEXP, SEXP sigma_GvSEXP, SEXP pKSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _mmClust_ConditionalLL_ls_func(SEXP NSEXP, SEXP NGSEXP, SEXP VSEXP, SEXP KSEXP, SEXP std_dataSEXP, SEXP pVKSEXP, SEXP mu_GK_VSEXP, SEXP sigma_GVSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type N(NSEXP);
...
RcppExport SEXP _mmClust_mat_to_list(SEXP mSEXP, SEXP VSEXP, SEXP KSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _mmClust_sigma_GKV_func(SEXP mu_GK_V_newSEXP, SEXP std_dataSEXP, SEXP w_NK_VSEXP, SEXP NSEXP, SEXP NGSEXP, SEXP VSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_mmClust_rowSumsC", (DL_FUNC) &_mmClust_rowSumsC, 1},
    {"_mmClust_MarginalLL_v_func", (DL_FUNC) &_mmClust_MarginalLL_v_func, 7},
    {"_mmClust_ConditionalLL_ls_func", (DL_FUNC) &_mmClust_ConditionalLL_ls_func, 8},
    {"_mmClust_mat_to_list", (DL_FUNC) &_mmClust_mat_to_list, 3},
    {"_mmClust_sigma_GKV_func", (DL_FUNC) &_mmClust_sigma_GKV_func, 6},
    {NULL, NULL, 0}
};

RcppExport void R_init_mmClust(DllInfo *dll) {
