...
#' init.ls = mmClust_init(std.data=BA11_BA47_NG2000, V=5, G.K=20, initial.kmin=100,
...
#' res = mmClust(V, K, pV, pVK, mu_GK_V, sigma_GV, std.data, R2_cutoff = 0.22)
#' }
mmClust = function(V, K, pV, pVK, mu_GK_V, sigma_GV, std.data,
